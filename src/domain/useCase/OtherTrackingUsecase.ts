...
export class OtherTrackingUsecase implements TrackingUseCase {
  ...
  async config(): Promise<any> {
    console.log(`[OtherTrackingUsecase] - config - ${this.locationTracking}`);
  ...
  async define() {
    console.log(`[OtherTrackingUsecase] - define - ${this.locationTracking}`);
  ...
  async hasStartedLocation(): Promise<Boolean> {
    console.log(
      `[OtherTrackingUsecase] - hasStartedLocation - ${this.locationTracking}`
    );
  ...
  async startTracking(): Promise<any> {
    console.log(
      `[OtherTrackingUsecase] - startTracking - ${this.locationTracking}`
    );
